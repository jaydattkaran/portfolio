...
const Skills: React.FC = () => {
	const skills: Skill[] = [
		...
		{
			name: "FIgma",
			icon: <SiFigma className='text-white text-4xl hover:text-purple-500 transition-all duration-300 ease-in-out hover:scale-95' />,
		},
	];
	...
	return (
		<div className='flex flex-col items-center bg-slate-950 p-4 w-full max-h-screen xl:h-80  justify-center'>
			...
			<div className='mt-6 grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 px-4'>
